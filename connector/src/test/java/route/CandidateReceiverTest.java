...
public class CandidateReceiverTest extends AbstractJUnit4SpringContextTests {

    public static final Logger LOG = LoggerFactory.getLogger(CandidateReceiverTest.class);
